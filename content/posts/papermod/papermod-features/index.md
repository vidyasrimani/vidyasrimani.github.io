...
Create a page with `article.md` in `content` directory with following content

```shell
.
├── config.yml
├── content/
│   ├── articles.md   <--- Create article.md here
│   └── posts/
├── static/
└── themes/
    └── PaperMod/
...
**Note:** Articles Layout does not support Multilingual Month Translations.

ex: [articles.md](https://raw.githubusercontent.com/adityatelange/hugo-PaperMod/exampleSite/content/articles.md)
